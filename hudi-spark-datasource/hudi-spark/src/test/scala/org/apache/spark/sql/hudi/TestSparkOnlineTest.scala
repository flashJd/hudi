...
object TestSparkOnlineTest {
  ...
  def testInsertTable(spark: SparkSession): Unit = {
    spark.sql(s"insert into $tableName values ('1','a',10,timestamp '2020-05-20 11:01:21',3),('2','b',20,timestamp '2020-05-20 11:02:21',3)")
    spark.sql(s"insert into $tableName values ('3','c',30,timestamp '2020-05-20 11:03:21',4),('4','d',40,timestamp '2020-05-20 11:04:21',4)")
  }

  def testInsertOverWriteTable(spark: SparkSession): Unit = {
    spark.sql(s"insert overwrite table $tableName values ('1','aaa',10,timestamp '2020-05-20 11:01:21',3),('2','bbb',20,timestamp '2020-05-20 11:02:21',3)")
  }
