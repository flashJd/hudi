...
import org.apache.hudi.common.model.{HoodieTableType, OverwriteWithLatestAvroPayload}
...
class CustomTestTimeTravelQuery extends HoodieClientTestBase {
  ...
  def testTimeTravelQuery1(tableType: HoodieTableType): Unit = {
...
//      .setTableCreateSchema(conf.getString(FlinkOptions.SOURCE_AVRO_SCHEMA))
      ...
      .setPayloadClassName("OverwriteWithLatestAvroPayload")
