...
public class FlinkOptions extends HoodieConfig {
  ...
  public static final ConfigOption<String> CHAIN_SEARCH_MODE =
      ConfigOptions.key("chain.search_mode")
          .stringType()
  ...
  //  public static final ConfigOption<Integer> GET_BATCH_SIZE =
  //      ConfigOptions.key("chain.hbase.get.batch.size")
  //          .intType()
  //          .defaultValue(100)
  //          .withDescription(
